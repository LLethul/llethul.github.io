...
const getProjects = async ()=>{
    const { data  } = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(`https://api.github.com/users/${_config_json__WEBPACK_IMPORTED_MODULE_1__/* .social.github */ .xs.b}/repos`);
    return data;
};
const getBio = async ()=>{
    const { data  } = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(_config_json__WEBPACK_IMPORTED_MODULE_1__/* .bioUrl */ .e3);
    return data;
};
...
/* harmony export */ });
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(150);
...
const about = async (args)=>{
    const bio = await (0,_api__WEBPACK_IMPORTED_MODULE_0__/* .getBio */ .IF)();
    return bio;
};
...
/* harmony export */ });
/* harmony import */ var cowsay_browser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(925);
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(150);
...
/* harmony export */   "email": () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_4__.Do),
...
/* harmony export */ });
/* harmony import */ var _about__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(716);
/* harmony import */ var _projects__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(103);
/* harmony import */ var _social__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(831);
/* harmony import */ var _theme__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(427);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99);
/* harmony import */ var _weather__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(246);
/* harmony import */ var _neofetch__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(802);
/* harmony import */ var _cowsay__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(792);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_about__WEBPACK_IMPORTED_MODULE_0__, _projects__WEBPACK_IMPORTED_MODULE_1__, _utils__WEBPACK_IMPORTED_MODULE_4__, _weather__WEBPACK_IMPORTED_MODULE_5__, _cowsay__WEBPACK_IMPORTED_MODULE_7__]);
([_about__WEBPACK_IMPORTED_MODULE_0__, _projects__WEBPACK_IMPORTED_MODULE_1__, _utils__WEBPACK_IMPORTED_MODULE_4__, _weather__WEBPACK_IMPORTED_MODULE_5__, _cowsay__WEBPACK_IMPORTED_MODULE_7__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const package_namespaceObject = JSON.parse('{"i8":"2.14.1","Vl":"MIT","HO":{"axios":"^1.1.3","cowsay-browser":"^1.1.8","date-fns":"^2.28.0","next":"^13.0.2","react":"^18.1.0","react-dom":"^18.1.0","react-icons":"^4.6.0"},"v6":{"@types/node":"^18.11.9","@types/react":"^18.0.25","@typescript-eslint/eslint-plugin":"^5.42.1","@typescript-eslint/parser":"^5.42.1","autoprefixer":"^10.4.13","eslint":"8.27.0","eslint-config-next":"^13.0.2","eslint-plugin-next":"^0.0.0","eslint-plugin-prettier":"^4.2.1","eslint-plugin-react":"^7.31.10","gh-pages":"^4.0.0","husky":"^8.0.2","postcss":"^8.4.18","prettier":"^2.6.2","tailwindcss":"^3.2.2","typescript":"^4.8.4"}}');
// EXTERNAL MODULE: ./themes.json
var themes = __webpack_require__(876);
;// CONCATENATED MODULE: ./src/utils/bin/neofetch.ts
...
const getInfo = ()=>{
    ...
    const packages = Object.keys(package_namespaceObject.HO);
    const devPackages = Object.keys(package_namespaceObject.v6);
    const mainColor = getMainColor();
    let message = "";
    ...
    message += `<span style="color: ${mainColor}">License</span>: ${package_namespaceObject.Vl}\n`;
    message += `<span style="color: ${mainColor}">Version</span>: ${package_namespaceObject.i8}\n`;
    message += `<span style="color: ${mainColor}">Uptime</span>: ${(0,external_date_fns_.formatDistanceToNow)(visitedAt)}\n`;
    return message;
};
...
const projects = async (args)=>{
    const projects = await (0,_api__WEBPACK_IMPORTED_MODULE_0__/* .getProjects */ .mW)();
...
/* harmony export */ });
/* harmony import */ var _config_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(181);
...
/* harmony export */ });
/* harmony import */ var _themes_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(876);
...
/* harmony export */ });
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(761);
...
const help = async (args)=>{
    const commands = Object.keys(_index__WEBPACK_IMPORTED_MODULE_0__).sort().join(", ");
...
/* harmony import */ var _bin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(761);
/* harmony import */ var _themeProvider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(309);
            ...
            default:
                {
                    if (Object.keys(_bin__WEBPACK_IMPORTED_MODULE_2__).indexOf(cmd) === -1) {
                        ...
                        try {
                            const output1 = await _bin__WEBPACK_IMPORTED_MODULE_2__[cmd](args);
                            setHistory(output1);
                        } catch (error) {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(689);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _themes_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(876);
...
module.exports = JSON.parse('{"e3":"https://raw.githubusercontent.com/m4tt72/m4tt72/master/README.md","xs":{"b":"LLethul"},"rS":"gruvboxdark","Cg":true}');
